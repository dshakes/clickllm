...
from onpar.engines import MTP_NATIVE, LoraFleet, Setting
from onpar.fit import Fit, solve
...
def _pick_engine(hw: Hardware, req: Requirements) -> tuple[Engine, str]:
    ...
    # host fell straight through to them. `onpar box` would then bake
...
def demo() -> None:
    """Self-check. Run with `python -m onpar.plan`."""
    from onpar.hardware import Hardware
