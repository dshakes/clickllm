...
2. **It would break the offline promise.** `onpar fit` has zero runtime
...
#: captured traffic" is as central a sentence as onpar has. Excluding the
...
def demo() -> None:
    """Self-check. Run with `python -m onpar.intent`."""
