...
Stdlib only: `onpar` must stay installable with nothing but Python.
"""
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self) -> None:  # noqa: N802
        ...
        try:
            ...
            # missing $ONPAR_CATALOG file raises FileNotFoundError on every
