...
#: `onpar catalog update --apply` never printed "re-run fit before
...
class UpdateReport:
    ...
    def render(self) -> str:
        ...
        out.append("")
        out.append(summary)
        out.append("Nothing has been written. Apply with: onpar catalog update --apply")
        return "\n".join(out)
...
USER_AGENT = "onpar-catalog/0.1 (+https://github.com/dshakes/onpar)"
