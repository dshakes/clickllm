...
use onpar_core::runtime::vllm::Vllm;
use onpar_core::runtime::{Runtime, Target};
use onpar_core::spec::{Accelerator, Hardware, KvScheme, ModelSpec, Workload};

fn main() {
    let hw = Hardware {
        accelerator: Accelerator::Nvidia,
        name: "H100".into(),
        usable_bytes: 80 * onpar_core::spec::GIB,
