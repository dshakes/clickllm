...
//! ## What this is not
//!
//! Not an authentication system. If `ONPAR_ADMIN_TOKEN` is set it is
...
pub const TOKEN_ENV: &str = "ONPAR_ADMIN_TOKEN";
...
mod tests {
    ...
    fn an_empty_env_token_is_treated_as_unset_rather_than_as_the_password() {
        // `ONPAR_ADMIN_TOKEN=` is what a shell exports when the value it was
