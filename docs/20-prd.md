...
- **Language:** Python 3.13 for the loop/solver/eval (the ecosystem is Python); Go for the proxy datapath if NFR-1 proves tight under load — measure before assuming.
