...
[![tests](https://img.shields.io/badge/tests-1291-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1064 Python
```

**1,291 tests.** 1064 Python, 227 Rust. Ten of the Python tests skip on a bare
