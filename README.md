...
[![tests](https://img.shields.io/badge/tests-1954-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1707 Python
```

**1954 tests.** 1707 Python, 247 Rust. Eighteen of the Python tests skip on a
