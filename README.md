...
[![tests](https://img.shields.io/badge/tests-2183-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1934 Python
```

**2183 tests.** 1934 Python, 249 Rust. Eighteen of the Python tests skip on a
