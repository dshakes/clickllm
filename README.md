...
[![tests](https://img.shields.io/badge/tests-2158-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1909 Python
```

**2158 tests.** 1909 Python, 249 Rust. Eighteen of the Python tests skip on a
