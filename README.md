...
[![tests](https://img.shields.io/badge/tests-2199-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1950 Python
```

**2199 tests.** 1950 Python, 249 Rust. Eighteen of the Python tests skip on a
