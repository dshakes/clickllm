...
[![tests](https://img.shields.io/badge/tests-2021-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1772 Python
```

**2021 tests.** 1772 Python, 249 Rust. Eighteen of the Python tests skip on a
