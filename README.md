...
[![tests](https://img.shields.io/badge/tests-2028-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1779 Python
```

**2028 tests.** 1779 Python, 249 Rust. Eighteen of the Python tests skip on a
