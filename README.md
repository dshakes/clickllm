...
[![tests](https://img.shields.io/badge/tests-1145-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 918 Python
```

**1,145 tests.** 918 Python, 227 Rust. Ten of the Python tests skip on a bare
