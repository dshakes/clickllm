...
[![tests](https://img.shields.io/badge/tests-1672-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1445 Python
```

**1,672 tests.** 1445 Python, 227 Rust. Nineteen of the Python tests skip on a
