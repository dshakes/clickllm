...
[![tests](https://img.shields.io/badge/tests-2108-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1859 Python
```

**2108 tests.** 1859 Python, 249 Rust. Eighteen of the Python tests skip on a
