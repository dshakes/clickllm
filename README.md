...
[![tests](https://img.shields.io/badge/tests-1301-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1074 Python
```

**1,301 tests.** 1074 Python, 227 Rust. Ten of the Python tests skip on a bare
