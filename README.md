...
[![tests](https://img.shields.io/badge/tests-1911-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1664 Python
```

**1911 tests.** 1664 Python, 247 Rust. Eighteen of the Python tests skip on a
