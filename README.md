...
[![tests](https://img.shields.io/badge/tests-1907-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1660 Python
```

**1907 tests.** 1660 Python, 247 Rust. Eighteen of the Python tests skip on a
