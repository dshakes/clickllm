...
[![tests](https://img.shields.io/badge/tests-1294-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1067 Python
```

**1,294 tests.** 1067 Python, 227 Rust. Ten of the Python tests skip on a bare
