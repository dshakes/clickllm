...
[![tests](https://img.shields.io/badge/tests-1034-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 807 Python
```

**1,034 tests.** 807 Python, 227 Rust. Ten of the Python tests skip on a bare
