...
[![tests](https://img.shields.io/badge/tests-2100-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1851 Python
```

**2100 tests.** 1851 Python, 249 Rust. Eighteen of the Python tests skip on a
