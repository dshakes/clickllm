...
[![tests](https://img.shields.io/badge/tests-1188-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 961 Python
```

**1,188 tests.** 961 Python, 227 Rust. Ten of the Python tests skip on a bare
