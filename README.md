...
[![tests](https://img.shields.io/badge/tests-1218-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 991 Python
```

**1,218 tests.** 991 Python, 227 Rust. Ten of the Python tests skip on a bare
