...
[![tests](https://img.shields.io/badge/tests-2031-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1782 Python
```

**2031 tests.** 1782 Python, 249 Rust. Eighteen of the Python tests skip on a
