...
[![tests](https://img.shields.io/badge/tests-2106-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1857 Python
```

**2106 tests.** 1857 Python, 249 Rust. Eighteen of the Python tests skip on a
