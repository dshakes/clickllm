...
[![tests](https://img.shields.io/badge/tests-2197-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1948 Python
```

**2197 tests.** 1948 Python, 249 Rust. Eighteen of the Python tests skip on a
