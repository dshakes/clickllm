...
[![tests](https://img.shields.io/badge/tests-1835-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1608 Python
```

**1,835 tests.** 1608 Python, 227 Rust. Eighteen of the Python tests skip on a
