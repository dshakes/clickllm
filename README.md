...
[![tests](https://img.shields.io/badge/tests-1336-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1109 Python
```

**1,336 tests.** 1109 Python, 227 Rust. Ten of the Python tests skip on a bare
