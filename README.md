...
[![tests](https://img.shields.io/badge/tests-1905-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1658 Python
```

**1905 tests.** 1658 Python, 247 Rust. Eighteen of the Python tests skip on a
