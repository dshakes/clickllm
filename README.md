...
[![tests](https://img.shields.io/badge/tests-2160-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1911 Python
```

**2160 tests.** 1911 Python, 249 Rust. Eighteen of the Python tests skip on a
