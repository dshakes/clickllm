...
[![tests](https://img.shields.io/badge/tests-2070-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1821 Python
```

**2070 tests.** 1821 Python, 249 Rust. Eighteen of the Python tests skip on a
