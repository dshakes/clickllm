...
[![tests](https://img.shields.io/badge/tests-1986-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1737 Python
```

**1986 tests.** 1737 Python, 249 Rust. Eighteen of the Python tests skip on a
