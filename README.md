...
[![tests](https://img.shields.io/badge/tests-1961-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1714 Python
```

**1961 tests.** 1714 Python, 247 Rust. Eighteen of the Python tests skip on a
