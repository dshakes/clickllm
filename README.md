...
[![tests](https://img.shields.io/badge/tests-1696-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1469 Python
```

**1,696 tests.** 1469 Python, 227 Rust. Nineteen of the Python tests skip on a
