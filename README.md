...
[![tests](https://img.shields.io/badge/tests-1638-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1411 Python
```

**1,638 tests.** 1411 Python, 227 Rust. Nineteen of the Python tests skip on a
