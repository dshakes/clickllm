...
[![tests](https://img.shields.io/badge/tests-971-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 744 Python
```

**971 tests.** Eight of the Python tests exercise the PyO3 bridge and skip unless
