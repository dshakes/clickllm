...
[![tests](https://img.shields.io/badge/tests-1858-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1631 Python
```

**1858 tests.** 1626 Python, 227 Rust. Eighteen of the Python tests skip on a
