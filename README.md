...
[![tests](https://img.shields.io/badge/tests-1909-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1662 Python
```

**1909 tests.** 1662 Python, 247 Rust. Eighteen of the Python tests skip on a
