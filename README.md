...
[![tests](https://img.shields.io/badge/tests-1777-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1550 Python
```

**1,777 tests.** 1550 Python, 227 Rust. Eighteen of the Python tests skip on a
