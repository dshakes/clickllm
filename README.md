...
[![tests](https://img.shields.io/badge/tests-968-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 741 Python
```

**968 tests.** Eight of the Python tests exercise the PyO3 bridge and skip unless
