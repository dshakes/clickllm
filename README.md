...
[![tests](https://img.shields.io/badge/tests-1382-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1155 Python
```

**1,382 tests.** 1155 Python, 227 Rust. Ten of the Python tests skip on a bare
