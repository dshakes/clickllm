...
[![tests](https://img.shields.io/badge/tests-2090-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1841 Python
```

**2090 tests.** 1841 Python, 249 Rust. Eighteen of the Python tests skip on a
