...
[![tests](https://img.shields.io/badge/tests-2024-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1775 Python
```

**2024 tests.** 1775 Python, 249 Rust. Eighteen of the Python tests skip on a
