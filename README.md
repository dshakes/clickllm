...
[![tests](https://img.shields.io/badge/tests-2003-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1754 Python
```

**2003 tests.** 1754 Python, 249 Rust. Eighteen of the Python tests skip on a
