...
[![tests](https://img.shields.io/badge/tests-2150-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1901 Python
```

**2150 tests.** 1901 Python, 249 Rust. Eighteen of the Python tests skip on a
