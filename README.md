...
[![tests](https://img.shields.io/badge/tests-2022-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1773 Python
```

**2022 tests.** 1773 Python, 249 Rust. Eighteen of the Python tests skip on a
