...
[![tests](https://img.shields.io/badge/tests-1073-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 846 Python
```

**1,073 tests.** 846 Python, 227 Rust. Ten of the Python tests skip on a bare
