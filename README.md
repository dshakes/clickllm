...
[![tests](https://img.shields.io/badge/tests-1200-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 973 Python
```

**1,200 tests.** 973 Python, 227 Rust. Ten of the Python tests skip on a bare
