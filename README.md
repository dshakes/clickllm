...
[![tests](https://img.shields.io/badge/tests-2000-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1751 Python
```

**2000 tests.** 1751 Python, 249 Rust. Eighteen of the Python tests skip on a
