...
[![tests](https://img.shields.io/badge/tests-1876-34d399?style=flat-square)](#verification)
...
```bash
cargo test --all                                   # 242 Rust
cargo clippy --all-targets -- -D warnings
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1634 Python
```

**1876 tests.** 1634 Python, 242 Rust. Eighteen of the Python tests skip on a
