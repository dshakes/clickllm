...
[![tests](https://img.shields.io/badge/tests-978-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 751 Python
```

**978 tests.** Eight of the Python tests exercise the PyO3 bridge and skip unless
