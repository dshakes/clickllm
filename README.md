...
[![tests](https://img.shields.io/badge/tests-1297-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1070 Python
```

**1,297 tests.** 1070 Python, 227 Rust. Ten of the Python tests skip on a bare
