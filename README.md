...
[![tests](https://img.shields.io/badge/tests-2110-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1861 Python
```

**2110 tests.** 1861 Python, 249 Rust. Eighteen of the Python tests skip on a
