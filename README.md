...
[![tests](https://img.shields.io/badge/tests-923-34d399?style=flat-square)](#verification)
...
uv run --with pytest --python 3.13 pytest -q       # 696 Python
```

**923 tests.** Eight of the Python tests exercise the PyO3 bridge and skip unless
