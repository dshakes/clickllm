...
[![tests](https://img.shields.io/badge/tests-1995-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1746 Python
```

**1995 tests.** 1746 Python, 249 Rust. Eighteen of the Python tests skip on a
