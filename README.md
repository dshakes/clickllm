...
[![tests](https://img.shields.io/badge/tests-929-34d399?style=flat-square)](#verification)
...
uv run --with pytest --python 3.13 pytest -q       # 702 Python
```

**929 tests.** Eight of the Python tests exercise the PyO3 bridge and skip unless
