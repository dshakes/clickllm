...
[![tests](https://img.shields.io/badge/tests-1984-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1735 Python
```

**1984 tests.** 1735 Python, 249 Rust. Eighteen of the Python tests skip on a
