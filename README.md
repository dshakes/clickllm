...
[![tests](https://img.shields.io/badge/tests-2098-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1849 Python
```

**2098 tests.** 1849 Python, 249 Rust. Eighteen of the Python tests skip on a
