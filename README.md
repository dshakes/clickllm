...
[![tests](https://img.shields.io/badge/tests-1184-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 957 Python
```

**1,184 tests.** 957 Python, 227 Rust. Ten of the Python tests skip on a bare
