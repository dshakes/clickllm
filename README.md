...
[![tests](https://img.shields.io/badge/tests-1755-34d399?style=flat-square)](#verification)
...
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1528 Python
```

**1,755 tests.** 1528 Python, 227 Rust. Eighteen of the Python tests skip on a
