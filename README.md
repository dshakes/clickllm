...
[![tests](https://img.shields.io/badge/tests-1866-34d399?style=flat-square)](#verification)
...
```bash
cargo test --all                                   # 234 Rust
cargo clippy --all-targets -- -D warnings
uv run --with pytest --with pyyaml --python 3.13 pytest -q   # 1632 Python
```

**1866 tests.** 1632 Python, 234 Rust. Eighteen of the Python tests skip on a
